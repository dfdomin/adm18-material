...
# 08-MEJORADO — versión corregida (contraste GTC 185, semanas 4 y 6)
# El par "con errores" vive en 08_correo_nacionalizacion_errores.pdf (render simple).
DOCS.append(([
 ('section','Encabezado del mensaje',[
   ('De','Diana Ramírez — Analista de Comercio Exterior · comercioexterior@latambox.com'),
   ('Para','Carlos Andrés Martínez — LBX-1029'),
   ('Asunto','Tu paquete está en proceso de nacionalización — LBX-2026-00478'),
   ('Fecha','16 de febrero de 2026'),
 ]),
 ('para','Estimado Carlos: tu paquete llegó a Barranquilla en el vuelo del 13 de febrero y ya ingresó al proceso de nacionalización ante la DIAN.'),
 ('table','Estado actual del trámite',['Etapa','Estado','Fecha'],[
 ...
 ('table','Documentos presentados ante la DIAN',['Documento','Estado'],[
   ['Factura comercial de Amazon (#114-8395627-0123456)','Presentada'],
   ['Guía aérea AWB 420-88472109','Presentada'],
   ['Declaración de valor (DV-2026-00478)','Presentada'],
   ['Certificado TLC — 0% de arancel (Colombia–EE. UU.)','Presentado'],
 ], [3,1.4]),
 ('table','Impuestos estimados (sujetos a verificación de la DIAN)',['Concepto','Base (USD)','Tarifa','Estimado (USD)'],[
   ['Arancel (TLC)','$435.97','0%','$0.00'],
   ['IVA (19% sobre el CIF)','$446.08','19%','$84.76'],
   ['Total estimado','—','—','$84.76'],
 ], [2,1.1,0.9,1.2]),
 ('section','Próximos pasos',[
   ('1','La DIAN liquidará los impuestos en los próximos 2 a 4 días hábiles.'),
   ('2','Recibirás un correo con el comprobante de pago y el monto exacto a pagar.'),
   ('3','Una vez realizado el pago, la DIAN emitirá el levante y tu paquete quedará libre para entrega.'),
 ]),
 ('note','El valor final depende de la TRM del día de liquidación y de la verificación de la DIAN sobre los valores declarados. Cualquier diferencia será notificada de inmediato.'),
 ('section','Mejoras aplicadas frente a la versión con errores (GTC 185)',[
   ('Membrete','Se identifica al emisor (área y responsable), no un genérico "el área de comercio exterior".'),
   ('Fecha completa','16 de febrero de 2026 (día, mes y año), no una fecha parcial.'),
   ('Asunto específico','Menciona el trámite y el número de envío; permite decidir si leer ahora.'),
   ('Destinatario identificado','Nombre y código de cliente, no "estimado cliente".'),
   ('Trazabilidad','Incluye envío, AWB, declaración y valores; la versión con errores no permitía localizar el caso.'),
   ('Párrafos breves y tono profesional','Se elimina el tono acusatorio y las mayúsculas; se informa sin culpar al cliente.'),
   ('Firma con cargo','Cierra con nombre y cargo (responsable del contenido).'),
   ('Anexos listados','Se enumera la documentación asociada al trámite.'),
 ]),
 ('sig',['Diana Ramírez','Analista de Comercio Exterior','LatamBox S.A.S.','comercioexterior@latambox.com']),
], meta('08_correo_nacionalizacion_mejorado','08','NACIONALIZACIÓN','Aviso al cliente — estado del trámite (versión corregida · contraste GTC 185)','EXPEDIENTE DIDÁCTICO / LBX-2026-00478','2026-02-16')))
